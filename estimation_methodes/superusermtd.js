module.exports = {
  EstimationComparaison: Bien => {
    ...
    for (var bien = 0; bien < json.maisons.length; bien++) {
      if (
        json.maisons[bien].bienImmobillier.localisationBien.codePostal ==
        Bien.codePostal
      ) {
        estime =
          estime +
          json.maisons[bien].estimation.prix_estimation.methodecomparaison;
        surfacemoy =
          surfacemoy + json.maisons[bien].informations.surfaceHabitable;
        nbr++;
      }
    }
    ...
    Bien.prix_comparaison =
      Bien.prix_comparaison -
      (Bien.decoteBienOccupe +
        Bien.autresElements +
        Bien.travauxARealiser +
        Bien.valorisationTerrain +
        Bien.renove);
    console.log("prix comparaison :" + Bien.prix_comparaison);
  ...
  EstimationReference: Bien => {
    ...
    for (var bien = 0; bien < json.maisons.length; bien++) {
      if (
        json.maisons[bien].informations.surfaceHabitable - 5 <=
    ...
    if (bienSimilaire.informations.nombrePieces > Bien.nombrePieces) {
      Bien.prix_reference =
        Bien.prix_reference +
        1000 * (bienSimilaire.informations.nombrePieces - Bien.nombrePieces);
    }
    if (Bien.nombrePieces > bienSimilaire.informations.nombrePieces) {
      Bien.prix_reference =
        Bien.prix_reference -
        1000 * (Bien.nombrePieces - bienSimilaire.informations.nombrePieces);
    }
    ////////////
    if (bienSimilaire.informations.nombreChambres > Bien.nombreChambres) {
      Bien.prix_reference =
        Bien.prix_reference +
        1000 *
          (bienSimilaire.informations.nombreChambres - Bien.nombreChambres);
    }
    if (Bien.nombreChambres > bienSimilaire.informations.nombreChambres) {
      Bien.prix_reference =
        Bien.prix_reference -
        1000 *
          (Bien.nombreChambres - bienSimilaire.informations.nombreChambres);
    }
    ///////////
    if (bienSimilaire.informations.nombreNiveaux > Bien.nombreNiveaux) {
      Bien.prix_reference =
        Bien.prix_reference +
        1000 * (bienSimilaire.informations.nombreNiveaux - Bien.nombreNiveaux);
    }
    if (Bien.nombreNiveaux > bienSimilaire.informations.nombreNiveaux) {
      Bien.prix_reference =
        Bien.prix_reference -
        1000 * (Bien.nombreNiveaux - bienSimilaire.informations.nombreNiveaux);
    }
    //////////
    if (bienSimilaire.informations.prixm2 > Bien.prixm2) {
      Bien.prix_reference =
        Bien.prix_reference +
        1000 * (bienSimilaire.informations.prixm2 - Bien.prixm2);
    }
    if (Bien.prixm2 > bienSimilaire.informations.prixm2) {
      Bien.prix_reference =
        Bien.prix_reference -
        1000 * (Bien.prixm2 - bienSimilaire.informations.prixm2);
    }
    ...
    Bien.prix_reference =
      ...
      (Bien.decoteBienOccupe +
        ...
        Bien.valorisationTerrain +
        Bien.renove);
    console.log("prix reference : " + Math.round(Bien.prix_reference));
    Bien.prix_reference = 1000;
    //console.log(Math.round(Bien.prix_reference));
    return Bien;
  },

  EstimationCapitalisation: Bien => {
    Bien.prix_capitalisation =
      (Bien.valeurLocative * 12) / (Bien.tauxCapitalisation / 100);
    Bien.prix_capitalisation =
      Bien.prix_capitalisation -
      (Bien.decoteBienOccupe +
        Bien.autresElements +
        ...
        Bien.valorisationTerrain +
        Bien.renove);
    console.log("prix capitalisation : " + Bien.prix_capitalisation);
    Bien.prix_capitalisation = 1000;
    return Bien;
  }
};
