...
class BecomePremium extends Component {
  render() {
    ...
    const client = {
      sandbox:
        "AUQ9lu8J8H1c-8Uz1uS-439wg0w6YdCFm8DUzjFcNzIuT5vZs3N0uQNkpzfGg1CAHCoQ9nU_3e561-PL",
    ...
    return (
      <div>
        <div className="columns is-centered pt-is-10percent">
          <div className="column">
            <h1>Devenir premium</h1>
            <p>
              Devenir premium pour la <b>modique somme de 20€ </b> vous permetra
              de :
            </p>
            <ul>
