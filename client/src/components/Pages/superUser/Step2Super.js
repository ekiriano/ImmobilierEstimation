              ...
              <div className="field-body">
                <div className="field">
                  <p className="control">
                    ...
                    />
                    {errors.codePostal && (
                      <p className="help is-danger">{errors.codePostal}</p>
                    )}
                  </p>
                </div>
              </div>
              ...
              <div className="field-body">
                <div className="field">
                  <p className="control">
                    ...
                    />
                    {errors.nombrePieces && (
                      <p className="help is-danger">{errors.nombrePieces}</p>
                    )}
                  </p>
                </div>
              </div>
                ...
                <div className="field">
                  <p className="control">
                    ...
                    {errors.nombreChambres && (
                      <p className="help is-danger">{errors.nombreChambres}</p>
                    )}
                  </p>
                </div>
              </div>
                ...
                <div className="field">
                  <p className="control">
                    ...
                    {errors.surfaceTerrain && (
                      <p className="help is-danger">{errors.surfaceTerrain}</p>
                    )}
                  </p>
                </div>
              </div>
                ...
                <div className="field">
                  <p className="control">
                    ...
                    {errors.nombreNiveaux && (
                      <p className="help is-danger">{errors.nombreNiveaux}</p>
                    )}
                  </p>
                </div>
              </div>
              ...
              <div className="field-body">
                <div className="field">
                  <p className="control">
                    ...
                    />
                    {errors.prixMandat && (
                      <p className="help is-danger">{errors.prixMandat}</p>
                    )}
                  </p>
                </div>
              </div>
              ...
              <div className="field-body">
                <div className="field">
                  ...
                  {errors.impotsFonciers && (
                    <p className="help is-danger">{errors.impotsFonciers}</p>
                  )}
                </div>
              </div>
            </div>
